...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'AdvIncremento
        '
        Me.AdvIncremento.DisabledBackColor = System.Drawing.Color.White
        Me.AdvIncremento.DisplayField = "CodTrabajo"
        Me.AdvIncremento.EntityName = "ObraTrabajoPresup"
        Me.AdvIncremento.Location = New System.Drawing.Point(128, 96)
        Me.AdvIncremento.Name = "AdvIncremento"
        Me.AdvIncremento.SecondaryDataFields = "IDTrabajoPresup"
        Me.AdvIncremento.Size = New System.Drawing.Size(100, 23)
...
#Region " Load "
    ...
    Public Sub AbrirADDIncrementos(ByVal IncrementoA As AplicarPorcentajeA, ByVal drTrabajo As DataRow)
        ...
        If mdrTrabajo("TipoLinea") = enumTipoLineaTrabajo.tltPorcentajeConcepto Then
            ...
            mintIDTrabajoIncremento = drTrabajo("IDTrabajoPresup")
            mdblIncremento = drTrabajo("ImpPresupTrabajoA") * 100
        End If
...
#End Region
    ...
    Private Sub AdvIncremento_SetPredefinedFilter(ByVal sender As Object, ByVal e As Engine.UI.AdvSearchFilterEventArgs) Handles AdvIncremento.SetPredefinedFilter
        If length(mdrTrabajo("IDPresup")) > 0 Then
            e.Filter.Add(New NumberFilterItem("IDPresup", mdrTrabajo("IDPresup")))
        End If
    ...
    Private Sub AdvIncremento_SelectionChanged(ByVal sender As Object, ByVal e As Engine.UI.AdvSearchSelectionChangedEventArgs) Handles AdvIncremento.SelectionChanged
        If Not IsNothing(e.Selected) AndAlso length(e.Selected.Rows(0)("IDTrabajoPresup")) > 0 Then
            mintIDTrabajoIncremento = e.Selected.Rows(0)("IDTrabajoPresup")
            mdblIncremento = e.Selected.Rows(0)("ImpPresupTrabajoA") * 100
    ...
    Private Sub CmbAceptar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmbAceptar.Click
        ...
        If Not chkAddMateriales.Checked AndAlso Not chkAddMOD.Checked AndAlso Not chkAddCentros.Checked Then
            ExpertisApp.GenerateMessage("Debe seleccionar, como mínimo, un concepto donde generar el incremento.", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        ElseIf Length(AdvIncremento.Value) > 0 Then
            ...
            info.IDPresup = mdrTrabajo("IDPresup")
            info.IDTrabajo = mdrTrabajo("IDTrabajoPresup")
            ...
            ExpertisApp.ExecuteTask(Of Incrementos.dataIncrementos)(AddressOf Incrementos.ADDPorcentajesPresupuestos, info)

            Me.DialogResult = DialogResult.OK
        Else
            ExpertisApp.GenerateMessage("El Incremento ha de ser mayor que cero.", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        End If
    End Sub
